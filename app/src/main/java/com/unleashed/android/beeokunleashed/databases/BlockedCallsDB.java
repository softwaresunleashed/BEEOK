...
public class BlockedCallsDB {
    ...
    private static final String databasename = "BlockedCallsDB";
    private static final String tablename = "BlockedCallsTable";    // TableName should NEVER be 'table' 'Table' 'TABLE'
   ...
   // "create table JobTable (Id integer primary key AUTOINCREMENT, " + "JobId text not null, PhnNums text not null, Msg text not null);";
    ...
    public BlockedCallsDB connect() /* throws SQLException */  {
        try{
