...
public abstract class CallStateReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        Log.i(Constants.APP_NAME_TAG, "CallStateReceiver.java:onReceive()");
    ...
    public void onCallStateChanged(Context context, int state, String number) {
        Log.i(Constants.APP_NAME_TAG, "CallStateReceiver.java:onCallStateChanged()" + "Context="+context + " state="+state + " number=" + number);
        ...
        switch (state) {
            case TelephonyManager.CALL_STATE_RINGING:
                Log.i(Constants.APP_NAME_TAG, "CallStateReceiver.java:onCallStateChanged()...CALL_STATE_RINGING");
                isIncoming = true;
            ...
            case TelephonyManager.CALL_STATE_OFFHOOK:
                Log.i(Constants.APP_NAME_TAG, "CallStateReceiver.java:onCallStateChanged()...CALL_STATE_OFFHOOK");
            ...
            case TelephonyManager.CALL_STATE_IDLE:
                Log.i(Constants.APP_NAME_TAG, "CallStateReceiver.java:onCallStateChanged()...CALL_STATE_IDLE");
