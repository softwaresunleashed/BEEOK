...
public class RecordCallsDB {

    private static final String Id = "Id";       // Automatic increment

    private static final String databasename = "RecordCallsDB";
    private static final String tablename = "RecordCallsTable";    // TableName should NEVER be 'table' 'Table' 'TABLE'
   ...
   // "create table JobTable (Id integer primary key AUTOINCREMENT, " + "JobId text not null, PhnNums text not null, Msg text not null);";
    ...
    public RecordCallsDB(Context context) {
        this.ct = context;
    ...
    public RecordCallsDB connect() /* throws SQLException */  {
        try{
